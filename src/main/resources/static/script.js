...
function addMarkers(points) {
    ...
    points.forEach(point => {
        ...
        places[placeKey] = new google.maps.marker.AdvancedMarkerElement({
            map,
            position: position,
            title: placeKey,
            content: pinSvg
        });
    places[placeKey].addListener('click', function () {
...
// };
function calculateRoute(map, origin, destination) { // czy gdyby tu nie było map w argumentach to by działało??
    const requestBody = {
        origin: {
            location: {
                latLng: {
